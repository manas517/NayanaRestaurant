...
public class PopularLunchComboMeals extends AppCompatActivity {
    ...
    private ConstraintLayout popular_combo_meal_lay;
            ...
            public void onResponse(Call<DashboardModel> call, Response<DashboardModel> response) {
                if (response.isSuccessful()) {
                    ...
                    if (sectionArrayList.size() > 0) {
                        if (popular_combo_meal_lay!=null){
                            popular_combo_meal_lay.setVisibility(View.VISIBLE);
                        }
    ...
    private void setFindViewId() {
        popular_combo_meal_lay=findViewById(R.id.popular_com_lay);
